...
Tags: page announcements, announcements, announcement, announcement system, page message, page messages, page news, news slides, news snippets, announcement messages
Requires at least: 2.9
Tested up to: 2.9.2
Stable tag: 1.0

This plugin enables you to display announcements on your blog posts and pages. Requires PHP 5.0 or later.
...
MooTools - you are only limited by your creativity!
...
CSS file or you can place CSS code in your theme's header file. The flexibility of this means that you can incorporate any type 
of effects using CSS and JavaScript frameworks such as jQuery and MooTools - you are only limited by your creativity!

= Can I Use This In My Header/Footer/Sidebar? =

This plugin can only be used in a post or page. If there is enough demand, we will release a widget that will work in your 
header/footer/sidebar too.
